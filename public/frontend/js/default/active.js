(function () {
    ...
    // :: Navbar
    $("#b2eNavbarToggler").on("click", function () {
    ...
    // :: Dropdown Menu
    $(".sidenav-nav").find("li.b2e-dropdown-menu").append("<div class='dropdown-trigger-btn'><i class='lni lni-chevron-down'></i></div>");
