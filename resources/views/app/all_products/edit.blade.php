@extends('layouts.app')
@section('title') {{__('crud.all_products.edit_title')}} @endsection
@section('section-title') {{__('crud.all_products.edit_title')}} @endsection
@push('stylesheet')
...
@section('section-content')
            ...
            <form
                method="POST"
                action="{{ route('all-products.update', $products) }}"
