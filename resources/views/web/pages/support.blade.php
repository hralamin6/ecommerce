            ...
            <div class="accordion" id="accordion1">
              ...
              <div class="accordian-header" id="headingOne">
                <button class="d-flex align-items-center justify-content-between w-100 collapsed btn" type="button"
                  ...
                  aria-controls="collapseOne"><span><i class="lni lni-bi-cycle"></i>How to get started?</span><i
              ...
              <div class="collapse" id="collapseOne" aria-labelledby="headingOne" data-bs-parent="#accordion1">
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Libero excepturi tempore exercitationem
                  porro dignissimos.</p>
              </div>
              <!-- Single Accordian-->
              <div class="accordian-header" id="headingTwo">
                <button class="d-flex align-items-center justify-content-between w-100 collapsed btn" type="button"
                  ...
                  aria-controls="collapseTwo"><span><i class="lni lni-cart-full"></i>How to buy a product?</span><i
                    class="lni lni-chevron-right"></i></button>
              </div>
            ...
            <div class="accordion" id="accordion2">
              ...
              <div class="accordian-header" id="headingThree">
                <button class="d-flex align-items-center justify-content-between w-100 collapsed btn" type="button"
                  ...
                  aria-controls="collapseThree"><span><i class="lni lni-dropbox"></i>How can upload a product?</span><i
                    class="lni lni-chevron-right"></i></button>
              </div>
              ...
              <div class="accordian-header" id="headingFour">
                <button class="d-flex align-items-center justify-content-between w-100 collapsed btn" type="button"
                  ...
                  aria-controls="collapseFour"><span><i class="lni lni-dollar"></i>Commission structure</span><i
                    class="lni lni-chevron-right"></i></button>
              </div>
            ...
            <div class="accordion" id="accordion3">
              ...
              <div class="accordian-header" id="headingFive">
                <button class="d-flex align-items-center justify-content-between w-100 collapsed btn" type="button"
                  ...
                  aria-controls="collapseFive"><span><i class="lni lni-exit"></i>How to return a product?</span><i
                    class="lni lni-chevron-right"></i></button>
              </div>
              ...
              <div class="accordian-header" id="headingSix">
                <button class="d-flex align-items-center justify-content-between w-100 collapsed btn" type="button"
                  ...
                  aria-controls="collapseSix"><span><i class="lni lni-emoji-sad"></i>My product is misleading?</span><i
                    class="lni lni-chevron-right"></i></button>
              </div>
